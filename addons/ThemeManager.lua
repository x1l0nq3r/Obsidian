...
ThemeManager.BuiltInThemes = {
    ...
    ["Moon"] =            { FontColor = "e0e0ff", MainColor = "1a1a2e", AccentColor = "7c8db5", BackgroundColor = "0f0f1e", OutlineColor = "2d2d44" },
    ["Midnight Purple"] = { FontColor = "e6e6fa", MainColor = "1c1430", AccentColor = "9d7cd8", BackgroundColor = "13101f", OutlineColor = "2e2547" },
}
